        ...
        <div className='px-8 mx-8 bg-[#1C1C1C] mt-5 rounded'>
            <form className='flex flex-wrap w-full items-start justify-between px-2 py-4'>
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' placeholder='Write description...' name="" id=""></textarea>
